...
class SequenceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #feat = torch.unsqueeze( torch.tensor( feat ), dim = 1 )
        # フレーム数 x 次元数の配列に変形
...
def main():
    ...
    dataset = SequenceDataset("/home/uchiyats/non-ar-asr-wav/01compute_features/wav/test/feats.scp","/home/uchiyats/non-ar-asr-wav/09transformer_conv_non_ar_wav/exp_train_large/data/char/label_test")
